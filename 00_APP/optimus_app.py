...
<section class="main"><header class="top"><div><h1 id="regionTitle">TC abdomen y pelvis</h1><div class="meta" id="caseMeta">Nuevo caso · sin guardar</div></div><div class="actions"><button class="pill advanced-toggle" id="advancedToggle" type="button" onclick="toggleAdminPanel()" aria-expanded="false">⚙ Estilo y reglas</button><button class="pill" id="themeToggle" type="button" onclick="toggleTheme()">Modo oscuro</button><button class="pill" onclick="revalidar()">Revalidar</button><button class="pill" onclick="copiarInforme()">Copiar</button><button class="pill primary" onclick="guardar()">Guardar</button></div></header><main class="chat" id="chat"><div class="thread" id="thread"><div class="welcome" id="welcome"><div class="biglogo">R</div><h2>¿Qué caso quieres informar?</h2><p>Pega el dictado abajo, revisa el informe y cópialo al PACS.</p><div class="cards"><div class="card"><b>Informe</b>Genera, edita, valida y guarda.</div><div class="card"><b>Estilo y reglas</b>Cambia el formato en lenguaje natural desde ⚙, con vista previa antes de aplicarlo.</div><div class="card"><b>Aprendizaje</b>Guarda correcciones y reglas candidatas.</div></div></div></div></main><div class="composer"><div class="box"><textarea id="caso" placeholder="Pega aquí el dictado bruto del caso…"></textarea><div class="row"><span class="status" id="estado"></span><button class="send" id="gen" onclick="generar()">↑</button></div></div></div></section>
